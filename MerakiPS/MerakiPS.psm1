...
$script:doDotSource = Get-PSFConfigValue -FullName MerakiPS.Import.DoDotSource -Fallback $false
if ($MerakiPS_dotsourcemodule) { $script:doDotSource = $true }
...
$importIndividualFiles = Get-PSFConfigValue -FullName MerakiPS.Import.IndividualFiles -Fallback $false
if ($MerakiPS_importIndividualFiles) { $importIndividualFiles = $true }
